...
/**
 * Standalone page for /juegos/banca-sabe/reglas. Thin wrapper — el
 * contenido narrativo vive en <BancaSabeReglasContent /> y se reutiliza
 * también desde los tabs "Reglas" del dealer y del jugador.
 */
export default function BancaSabeReglas() {
  return (
    <div
      style={{
        paddingTop: "3rem",
