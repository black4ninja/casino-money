...
/**
 * Standalone page for /juegos/showdown/reglas. Thin wrapper — el
 * contenido narrativo vive en <ShowdownReglasContent /> y se reutiliza
 * también desde los tabs "Reglas" del dealer y del jugador.
 */
export default function ShowdownReglas() {
  return (
    <div
      style={{
        paddingTop: "3rem",
