...
/**
 * Standalone page for /juegos/yahtzee/reglas. Thin wrapper — el
 * contenido narrativo vive en <YahtzeeReglasContent /> y se reutiliza
 * también desde los tabs "Reglas" del dealer y del jugador.
 */
export default function YahtzeeReglas() {
  return (
    <div
      style={{
        paddingTop: "3rem",
