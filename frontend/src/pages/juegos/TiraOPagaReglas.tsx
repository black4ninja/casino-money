...
/**
 * Standalone page for /juegos/tira-o-paga/reglas. Thin wrapper — el
 * contenido narrativo vive en <TiraOPagaReglasContent /> y se reutiliza
 * también desde los tabs "Reglas" del dealer y del jugador.
 */
export default function TiraOPagaReglas() {
  return (
    <div
      style={{
        paddingTop: "3rem",
