...
/**
 * Standalone page for /juegos/ruleta/reglas. Thin wrapper — the narrative
 * rules content lives in <RuletaReglasContent /> and is reused from the
 * dealer mesa "Reglas" tab.
 */
export default function RuletaReglas() {
  return (
    <div
      style={{
        paddingTop: "3rem",
