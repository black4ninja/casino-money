...
/**
 * Standalone page for /juegos/cubilete/reglas. Thin wrapper — el
 * contenido narrativo vive en <CubileteReglasContent /> y se reutiliza
 * también desde los tabs "Reglas" del dealer y del jugador.
 */
export default function CubileteReglas() {
  return (
    <div
      style={{
        paddingTop: "3rem",
