...
/**
 * Standalone page for /juegos/poker-holdem/reglas. Thin wrapper — el
 * contenido narrativo vive en <PokerHoldemReglasContent /> y se
 * reutiliza también desde los tabs "Reglas" del dealer y del jugador.
 */
export default function PokerHoldemReglas() {
  return (
    <div
      style={{
        paddingTop: "3rem",
